                                    ...
                                    <table bgcolor="#eacb3c" width="250" height="50" border="0" align="right" valign="middle" cellpadding="0" cellspacing="0" border="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td height="50" align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #282828" st-content="menu">
                                                <a href="#" style="color: #282828;text-decoration: none;">Home page</a>
                                                &nbsp;&nbsp;&nbsp;
                                                <a href="#" style="color: #282828;text-decoration: none;">Login</a>
                                                &nbsp;&nbsp;&nbsp;
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #282828; text-align:center; line-height: 24px;">
                                                Дякую що ви з нами, {{$user['name']}}. Реєстрація успішна.
                                            </td>
                                        </tr>
                                        <!-- End of Title -->
                                        <!-- spacing -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;">
                                                У своєму кабінеті ви зможете використовувати повний функціонал суйту.
                                                Сучасне обладнання укупі з величезним досвідом лікарів, дозволяють надавати найширший спектр лікувально-діагностичної допомоги.
                                                Лікарня має все необхідне для виконання найскладніших хірургічних втручань.
                                                Проводяться операції стентування коронарних артерій, ендопротезування колінних і тазостегнових суглобів, артроскопические операції.
                                                Унікальні методики використовуються при лікуванні урологічних та гінекологічних захворювань.
                                            </td>
                                        </tr>
                                        <!-- End of content -->
                                        <!-- Spacing -->
